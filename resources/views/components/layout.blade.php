                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="h-8 w-8 rounded-full"
                                            src="https://ideogram.ai/assets/image/lossless/response/3SD9XAXvTXygH972Yv0dzA"
                                            alt="">
                                    </button>
                                </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">Theikdi Sann</div>
                            <div class="text-sm font-medium leading-none text-gray-400">20011012theikdi@gmail.com</div>
                        </div>
                        <button type="button"
